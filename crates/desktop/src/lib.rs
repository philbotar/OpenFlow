...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::settings::import_mcp_config,
            commands::settings::apply_mcp_config,
            commands::settings::export_mcp_config,
            commands::settings::probe_mcp_server,
            commands::settings::list_mcp_capabilities,
            commands::settings::preview_mcp_resource,
            commands::settings::preview_mcp_prompt,
            commands::settings::start_mcp_oauth,
            commands::settings::mcp_oauth_status,
            commands::settings::refresh_mcp_oauth,
            commands::settings::disconnect_mcp_oauth,
            commands::settings::save_mcp_secret,
            commands::settings::delete_mcp_secret,
            commands::settings::search_mcp_registry,
            commands::settings::list_mcp_registry_versions,
            commands::settings::preview_mcp_registry_install,
            commands::settings::preview_mcp_registry_remote,
            commands::settings::install_mcp_package,
            commands::settings::cancel_mcp_install,
            commands::settings::rollback_mcp_install,
            ...
            commands::settings::refresh_provider_models,
            ...
            commands::run::load_file_change_diff,
            ...
            commands::run::resolve_mcp_client_request,
            commands::run::get_run_state,
            commands::run::clear_run_trace,
            commands::attachment::load_chat_attachment_preview,
            commands::attachment::stage_chat_attachment,
            commands::attachment::remove_staged_chat_attachment,
