...
| Tools (files, shell, search, …) | Inspector **Tools** → **Approval mode**; approve or deny in chat when prompted | [`../reference/tools.md`](../reference/tools.md), [`using-the-app.md`](using-the-app.md#tools-and-approval) |
